                    ...
                    <div class="row">
                            ...
                            <div class="mt-3">
                                ...
                                <div class="input-group d-flex">
                                    <span class="input-group-text">
                                        <img src="{{ asset('img/usa.jpg') }}" alt="" class="mw-100"
                                            style="height:20px">
                                        +1
                                    </span>
                                    <input type="tel" class="form-control shadow-none text-secondary"
                                        id="m-contact" placeholder="783 783 119 008" name="contact"
                                        value="{{ old('contact') }}">
                                </div>
                                @error('contact')
                                    <span class="error text-danger">
                        ...
                        <div class="col-sm-6">
                            <div class="mt-3">
                                ...
                                @else
                                    <input type="number" name="barcode" id="barcode" placeholder="0"
                                        class="form-control shadow-none text-secondary" maxlength="10"
                                        required="">
                ...
                <div class="send-bor2 shadow">
                    ...
                    <div class="p-3">
                        ...
                        <input type="email" class="text-secondary shadow-none border border-2 form-control"
                            placeholder="Member@Gmail.Com" value="{{ old('email') }}" name="mailid"
                            id="mail2" readonly required>
                        @error('mailid')
                            <span class="error text-danger">
                                {{ $message }}
                            </span>
                        @enderror
                        <textarea class="text-secondary form-control shadow-none border border-2 px-3 py-2 mt-2 rounded-3" name="msg"
                            rows="4" required>
@if (isset($saveSendMail))
{{ $saveSendMail->msg }}
@endif
</textarea>
                        {{-- <div class="mt-3">
                    ...
                    <div class="p-3">
                        ...
                        <div class="input-group d-flex">
                            ...
                            <input type="tel" class="form-control shadow-none text-secondary" id="phoneid"
                                placeholder="783 783 119 008" name="phoneid" value="{{ old('phoneid') }}" readonly required>
                        </div> @error('phoneid')
                            <span class="error text-danger">
                                {{ $message }}
                            </span>
                        @enderror
                        <textarea class="text-secondary form-control shadow-none border border-2 px-3 py-2 mt-2 rounded-3" rows="4"
                            name="msg" required>
@if (isset($saveSendPhone))
{{ $saveSendPhone->msg }}
@endif
</textarea>
                        {{-- <div class="mt-3">
    ...
    <section class="copyright pt-3 mb-2 mx-3">
        <p class="text-center bg-warning rounded-3 py-2 mb-0 blue-txt small">Developed & powered by <b>KEYTAG1 LLC.</b>
        </p>
    </section>
    <style>
        input::placeholder {
    ...
    <script>
        ...
        const phone1 = document.getElementById('m-contact');
        const phone2 = document.getElementById('phoneid');
        document.getElementById("password").autocomplete = "off";
        document.getElementById("m-name").autocomplete = "off";
