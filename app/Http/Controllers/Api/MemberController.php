...
class MemberController extends Controller
{
    ...
    public function getMember($id)
    {
        try {
            ...
            ->select('members.id','members.name','members.photo','members.address1','members.address2','barcode','annoucements.annoucement','users.photo as gym_photo','users.id as gym_id')->first();
            ...
            $data['details']['gym_id'] =  $details->gym_id;
